//
//  GTUIPaletteExpansions.m
//  GTCatalog
//
//  Created by liuxc on 2018/11/21.
//

#import "GTUIPaletteExpansions.h"
...
static int NameToIndex(NSString *_Nonnull name) {
    ...
    dispatch_once(&onceToken, ^{
        map = @{
                GTUI_PALETTE_TINT_50_INTERNAL_NAME : @(kQTMColorTint50Index),
                GTUI_PALETTE_TINT_100_INTERNAL_NAME : @(kQTMColorTint100Index),
                GTUI_PALETTE_TINT_200_INTERNAL_NAME : @(kQTMColorTint200Index),
                GTUI_PALETTE_TINT_300_INTERNAL_NAME : @(kQTMColorTint300Index),
                GTUI_PALETTE_TINT_400_INTERNAL_NAME : @(kQTMColorTint400Index),
                GTUI_PALETTE_TINT_500_INTERNAL_NAME : @(kQTMColorTint500Index),
                GTUI_PALETTE_TINT_600_INTERNAL_NAME : @(kQTMColorTint600Index),
                GTUI_PALETTE_TINT_700_INTERNAL_NAME : @(kQTMColorTint700Index),
                GTUI_PALETTE_TINT_800_INTERNAL_NAME : @(kQTMColorTint800Index),
                GTUI_PALETTE_TINT_900_INTERNAL_NAME : @(kQTMColorTint900Index),
                GTUI_PALETTE_ACCENT_100_INTERNAL_NAME : @(kQTMColorAccent100Index),
                GTUI_PALETTE_ACCENT_200_INTERNAL_NAME : @(kQTMColorAccent200Index),
                GTUI_PALETTE_ACCENT_400_INTERNAL_NAME : @(kQTMColorAccent400Index),
                GTUI_PALETTE_ACCENT_700_INTERNAL_NAME : @(kQTMColorAccent700Index)
                };
    });
...
UIColor *GTUIPaletteTintFromTargetColor(UIColor *targetColor, NSString *tintName) {
    NSCAssert(GTUIPaletteIsTintOrAccentName(tintName), @"Invalid tint/accent name %@.", tintName);
...
UIColor *GTUIPaletteAccentFromTargetColor(UIColor *targetColor, NSString *accentName) {
    NSCAssert(GTUIPaletteIsTintOrAccentName(accentName), @"Invalid tint/accent name %@.", accentName);
