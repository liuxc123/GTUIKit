...
@protocol GTUITypographyFontLoading <NSObject>
@required
...
@interface GTUITypography : NSObject

#pragma mark - Font loader access

/** Set the font loader in order to use a non-system font. */
+ (void)setFontLoader:(nonnull id<GTUITypographyFontLoading>)fontLoader;

/** Get the current font loader. */
+ (nonnull id<GTUITypographyFontLoading>)fontLoader;
...
/**
 GTUISystemFontLoader allows you to use the system font for @c GTUITypography.

 @warning This class will soon be deprecated. Consider using GTUITypographyScheme from the
 schemes/Typography component instead.

 #### Example

 ```
 [GTUITypography setFontLoader:[[GTUISystemFontLoader alloc] init]];
 ```
 */
@interface GTUISystemFontLoader : NSObject <GTUITypographyFontLoading>
@end
