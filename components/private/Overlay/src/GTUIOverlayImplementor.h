...
/**
 ...
 various GTUI components to have to link in the overlay manager just to post overlay change
 ...
 */
static NSString *const GTUIOverlayDidChangeNotification = @"GTUIOverlayDidChangeNotification";
 ...
 */
static NSString *const GTUIOverlayIdentifierKey = @"identifier";
...
/**
 ...
 coordinate space).
 */
static NSString *const GTUIOverlayFrameKey = @"frame";
 ...
 */
static NSString *const GTUIOverlayTransitionDurationKey = @"duration";
 ...
 */
static NSString *const GTUIOverlayTransitionCurveKey = @"curve";
 ...
 */
static NSString *const GTUIOverlayTransitionTimingFunctionKey = @"timingFunction";
 ...
 */
static NSString *const GTUIOverlayTransitionImmediacyKey = @"runImmediately";
