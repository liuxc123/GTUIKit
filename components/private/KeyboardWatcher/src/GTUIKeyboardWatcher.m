...
NSString *const GTUIKeyboardWatcherKeyboardWillShowNotification =
@"GTUIKeyboardWatcherKeyboardWillShowNotification";
NSString *const GTUIKeyboardWatcherKeyboardWillHideNotification =
@"GTUIKeyboardWatcherKeyboardWillHideNotification";
NSString *const GTUIKeyboardWatcherKeyboardWillChangeFrameNotification =
@"GTUIKeyboardWatcherKeyboardWillChangeFrameNotification";

static GTUIKeyboardWatcher *_sKeyboardWatcher;

@interface GTUIKeyboardWatcher ()
...
@implementation GTUIKeyboardWatcher
...
+ (void)load {
    @autoreleasepool {
        _sKeyboardWatcher = [[GTUIKeyboardWatcher alloc] init];
    }
}
...
+ (NSTimeInterval)animationDurationFromKeyboardNotification:(NSNotification *)notification {
    if (![notification.name isEqualToString:GTUIKeyboardWatcherKeyboardWillShowNotification] &&
        ![notification.name isEqualToString:GTUIKeyboardWatcherKeyboardWillHideNotification] &&
        ![notification.name isEqualToString:GTUIKeyboardWatcherKeyboardWillChangeFrameNotification]) {
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    [[NSNotificationCenter defaultCenter]
     postNotificationName:GTUIKeyboardWatcherKeyboardWillShowNotification
     object:self
...
- (void)keyboardWillChangeFrame:(NSNotification *)notification {
    [self updateKeyboardOffsetWithKeyboardUserInfo:notification.userInfo];
    [[NSNotificationCenter defaultCenter]
     postNotificationName:GTUIKeyboardWatcherKeyboardWillChangeFrameNotification
     object:self
     userInfo:notification.userInfo];
}
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    self.keyboardFrame = CGRectZero;
    [[NSNotificationCenter defaultCenter]
     postNotificationName:GTUIKeyboardWatcherKeyboardWillHideNotification
     object:self
     userInfo:notification.userInfo];
}
