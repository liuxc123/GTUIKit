//
//  GTUIBottomSheetTransitionController.m
//  GTCatalog
//
...
static const NSTimeInterval GTUIBottomSheetTransitionDuration = 0.25;

@implementation GTUIBottomSheetTransitionController {
...
{
    GTUIBottomSheetPresentationController *presentationController =
    [[GTUIBottomSheetPresentationController alloc] initWithPresentedViewController:presented
...
- (NSTimeInterval)transitionDuration:(nullable __unused id<UIViewControllerContextTransitioning>)transitionContext {
    return GTUIBottomSheetTransitionDuration;
}
