...
@class GTUIInkGestureRecognizer;
@class GTUIInkTouchController;
@class GTUIInkView;
@protocol GTUIInkTouchControllerDelegate;

/**
 GTUIInkTouchController associates a GTUIInkView with a UIGestureRecognizer to control the spread of
 the ink.
 ...
 GTUIInkTouchControllerDelegate.
 ...
 */
@interface GTUIInkTouchController : NSObject <UIGestureRecognizerDelegate>
 ...
 */
@property(nonatomic, strong, readonly, nonnull) GTUIInkView *defaultInkView;

/** Delegate to extend the behavior of the touch control. */
@property(nonatomic, weak, nullable) id<GTUIInkTouchControllerDelegate> delegate;
...
@property(nonatomic, strong, readonly, nonnull) GTUIInkGestureRecognizer *gestureRecognizer;
 ...
 */
- (GTUIInkView *_Nullable)inkViewAtTouchLocation:(CGPoint)location;

@end

/** Delegate methods for GTUIInkTouchController. */
@protocol GTUIInkTouchControllerDelegate <NSObject>
@optional
 ...
 */
- (void)inkTouchController:(nonnull GTUIInkTouchController *)inkTouchController
 ...
 */
- (nullable GTUIInkView *)inkTouchController:(nonnull GTUIInkTouchController *)inkTouchController
 ...
 */
- (BOOL)inkTouchController:(nonnull GTUIInkTouchController *)inkTouchController
 ...
 */
- (void)inkTouchController:(nonnull GTUIInkTouchController *)inkTouchController
         didProcessInkView:(nonnull GTUIInkView *)inkView
