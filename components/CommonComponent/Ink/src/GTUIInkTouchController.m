...
@interface GTUIInkTouchController ()
@property(nonatomic, strong) GTUIInkView *addedInkView;
@property(nonatomic, strong) GTUIInkView *defaultInkView;
@property(nonatomic, assign) BOOL shouldRespondToTouch;
@property(nonatomic, assign) CGPoint previousLocation;
@end

@protocol GTUIInkTouchControllerLegacyDelegate <NSObject>
@optional
...
(nonnull GTUIInkTouchController *)inkTouchController
...
@implementation GTUIInkTouchController
...
- (instancetype)initWithView:(UIView *)view {
    ...
    if (self) {
        _gestureRecognizer =
        [[GTUIInkGestureRecognizer alloc] initWithTarget:self action:@selector(handleInkGesture:)];
        _gestureRecognizer.delegate = self;

        _view = view;
        [_view addGestureRecognizer:_gestureRecognizer];

        _defaultInkView = [[GTUIInkView alloc] initWithFrame:view.bounds];
...
- (void)handleInkGesture:(GTUIInkGestureRecognizer *)recognizer {
...
- (void)cancelInkGestureWithRecognizer:(GTUIInkGestureRecognizer *)recognizer {
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    if ([_delegate respondsToSelector:@selector(inkTouchController:
        ...
        id<GTUIInkTouchControllerLegacyDelegate> legacyDelegate =
        (id<GTUIInkTouchControllerLegacyDelegate>)_delegate;
