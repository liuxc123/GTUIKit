...
@protocol GTUITextInputCharacterCounter;

/** Controllers that manipulate styling and animation of text inputs. */
@protocol GTUITextInputController <NSObject, NSCopying, GTUITextInputPositioningDelegate>
...
/**
 ...
 Default is an internal instance GTUITextInputAllCharactersCounter. Setting this property to null
 will reset it to return that instance.
 */
@property(nonatomic, null_resettable, weak) IBInspectable id<GTUITextInputCharacterCounter>
characterCounter;
...
/**
 ...
 Note: setErrorText:errorAccessibilityValue: also sets these GTUITextInput properties.
...
/*
 ...
 Default is gtui_adjustsFontForContentSizeCategoryDefault.
 */
@property(nonatomic, assign, readwrite, setter=gtui_setAdjustsFontForContentSizeCategory:)
BOOL gtui_adjustsFontForContentSizeCategory;

/** Default value for gtui_adjustsFontForContentSizeCategory. */
@property(class, nonatomic, assign) BOOL gtui_adjustsFontForContentSizeCategoryDefault;
...
@property(nonatomic, nullable, strong) UIView<GTUITextInput> *textInput;
...
/**
 ...
 @param input An GTUITextInput this controller will manage.
 */
- (nonnull instancetype)initWithTextInput:(nullable UIView<GTUITextInput> *)input;
...
/**
 ...
 This method is usually called from whatever object is the UITextFieldDelegate for the GTUITextField.
 ...
 Note: The characterCountMax property also affects these same GTUITextInput properties.
 */
