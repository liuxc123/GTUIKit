...
typedef void (^GTUIFlexibleHeaderChangeContentInsetsBlock)(void);
typedef void (^GTUIFlexibleHeaderShadowIntensityChangeBlock)(CALayer *_Nonnull shadowLayer,
                                                            CGFloat intensity);


/** Mutually exclusive phases that the flexible header view can be in. */
typedef NS_ENUM(NSInteger, GTUIFlexibleHeaderScrollPhase) {
     ...
     */
    GTUIFlexibleHeaderScrollPhaseShifting,
     ...
     */
    GTUIFlexibleHeaderScrollPhaseCollapsing,
    ...
    /**
     ...
     frame.size.height is changing.
     */
    GTUIFlexibleHeaderScrollPhaseOverExtending,
};

@protocol GTUIFlexibleHeaderViewDelegate;

/**
 GTUIFlexibleHeaderView tracks the content offset of a scroll view and adjusts its size and
 ...
 */
IB_DESIGNABLE
@interface GTUIFlexibleHeaderView : UIView
...
intensityDidChangeBlock:(nonnull GTUIFlexibleHeaderShadowIntensityChangeBlock)block;
 ...
 */
- (void)changeContentInsets:(nonnull GTUIFlexibleHeaderChangeContentInsetsBlock)block;
 ...
 */
@property(nonatomic, readonly) GTUIFlexibleHeaderScrollPhase scrollPhase;
...
/**
 ...
 GTUIFlexibleHeaderShiftBehaviorDisabled, an assertion will be thrown. If you intend to use any
...
@property(nonatomic, weak, nullable) id<GTUIFlexibleHeaderViewDelegate> delegate;

@end

/**
 The GTUIFlexibleHeaderViewDelegate protocol allows a delegate to respond to changes in the header
 view's state.

 The delegate is typically the UIViewController that owns this flexible header view.
 */
@protocol GTUIFlexibleHeaderViewDelegate <NSObject>
@required
...
(nonnull GTUIFlexibleHeaderView *)headerView;
...
/**
 ...
 should use the GTUIFlexibleHeaderView scrollPhase APIs to determine which phase the header's frame
 is in.
 */
- (void)flexibleHeaderViewFrameDidChange:(nonnull GTUIFlexibleHeaderView *)headerView;
