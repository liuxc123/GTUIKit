//
//  GTUIFlexibleHeaderViewController.h
//  GTCatalog
//
...
@class GTUIFlexibleHeaderView;
@protocol GTUIFlexibleHeaderViewLayoutDelegate;

/**
 The GTUIFlexibleHeaderViewController controller is a simple UIViewController-oriented interface
...
/**
 ...
 simple container view controller or by using GTUIFlexibleHeaderContainerViewController. This
...
/**
 ...
 GTUIFlexibleHeaderView.
 */
@protocol GTUIFlexibleHeaderViewLayoutDelegate <NSObject>
@required

/**
 Informs the receiver that the flexible header view's frame has changed.

 The receiver should use the GTUIFlexibleHeader scrollPhase APIs in order to react to the frame
 changes.
 */
- (void)flexibleHeaderViewController:
(nonnull GTUIFlexibleHeaderViewController *)flexibleHeaderViewController
    flexibleHeaderViewFrameDidChange:(nonnull GTUIFlexibleHeaderView *)flexibleHeaderView;

@end

@interface GTUIFlexibleHeaderViewController (ToBeDeprecated)

/**
 Updates the topLayoutGuide to the correct position of a view controller paired with an instance of
 GTUIFlexibleHeaderViewController.
