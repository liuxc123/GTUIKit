...
#import "GTUICheckBoxPath.h"

@implementation GTUICheckBoxPath
...
- (UIBezierPath *)pathForBox {
    ...
    switch (self.boxType) {
        case GTUICheckBoxTypeSquare:
            ...
            break;
        case GTUICheckBoxTypeCheckmark:
            break;
        default: {
...
- (UIBezierPath *)pathForCheckMark {
    ...
    if (self.boxType == GTUICheckBoxTypeSquare) {
