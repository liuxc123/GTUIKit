...
#import "GTUIToolBarLayer.h"

#import "GTMath.h"
#import "GTUIToolBarAttributes.h"

@interface GTUIToolBarLayer (PathGenerators)
...
- (UIBezierPath *)drawWithPlainPath:(UIBezierPath *)bottomBarPath
                          ...
                          arcRadius:(CGFloat)arcRadius;
@end
@implementation GTUIToolBarLayer

+ (instancetype)layer {
    GTUIToolBarLayer *layer = [super layer];
...
- (CGPathRef)pathFromRect:(CGRect)rect
    ...
    CGFloat arcRadius =
    CGRectGetHeight(floatingButton.bounds) / 2 + kGTUIToolBarFloatingButtonRadiusOffset;
