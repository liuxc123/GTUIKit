...
/** Specifies the title alignment of the |GTUINavigationBar|. */
typedef NS_ENUM(NSInteger, GTUINavigationBarTitleAlignment) {
    /** Aligns the title to the center of the NavigationBar. */
    GTUINavigationBarTitleAlignmentCenter,
    /** Aligns the title to the left/leading of the NavigationBar. */
    GTUINavigationBarTitleAlignmentLeading
};

/**
 Behaviors that affect the layout of an |GTUINavigationBar|'s titleView.
 */
typedef NS_ENUM(NSInteger, GTUINavigationBarTitleViewLayoutBehavior) {
    /**
     ...
     */
    GTUINavigationBarTitleViewLayoutBehaviorFill,

    /**
     Align the title view's center with the navigation bar's center, if possible.
     */
    GTUINavigationBarTitleViewLayoutBehaviorCenter
};
...
/**
 ...
 GTUINavigationBar.
 */
@protocol GTUINavigationItemObservables <NSObject>
@required
...
@class GTUINavigationBar;

/**
 The GTUINavigationBarTextColorAccessibilityMutator class creates an external object with which to
 work on an instance of a Material Navigation Bar to activate and ensure accessibility on its title
 and buttons.
 */

@interface GTUINavigationBarTextColorAccessibilityMutator : NSObject
...
/**
 ...
 navigation bar.
 */
- (void)mutate:(nonnull GTUINavigationBar *)navBar;

@end

/**
 The GTUINavigationBar class is a view consisting of a leading and trailing button bar, title label,
 ...
 */
IB_DESIGNABLE
@interface GTUINavigationBar : UIView
...
/**
 ...
 Due to GTUINavigationBar being able to expand vertically, the titleView's height is updated to match
 any changes in the GTUINavigationBar's height.
...
/**
 ...
 By default this is GTUINavigationBarTitleViewLayoutBehaviorFill.
 */
@property(nonatomic) GTUINavigationBarTitleViewLayoutBehavior titleViewLayoutBehavior;

/**
 The font applied to the title of navigation bar.
 Font size is enforced to 20.
 Both Default and null_resettable value is GTUITypography's titleFont.
...
/**
 ...
 GTUINavigationBarTitleAlignmentLeading.
 */
@property(nonatomic) GTUINavigationBarTitleAlignment titleAlignment;
