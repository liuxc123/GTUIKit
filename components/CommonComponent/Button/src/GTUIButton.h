...
/**  图片位置  */
typedef NS_ENUM(NSInteger, GTUIButtonImageLocation) {
    /**
     The image of the floating button is on the leading side of the title.
     */
    GTUIButtonImageLocationTop = 0,

    /**
     The image of the floating button is on the leading side of the title.
     */
    GTUIButtonImageLocationLeading = 1,

    /**
     The image of the floating button is on the bottom side of the title.
     */
    GTUIButtonImageLocationBottom = 2,

    /**
     The image of the floating button is on the trailing side of the title.
     */
    GTUIButtonImageLocationTrailing = 3,
};

/**
 定制Button样式
 */
@interface GTUIButton : UIButton

/** The ink style of the button. */
@property(nonatomic, assign) GTUIInkStyle inkStyle UI_APPEARANCE_SELECTOR;
...
/**
 The location of the image relative to the title when the GTUIButton is in @c expanded mode.

 The default value is @c .leading .
 */
@property(nonatomic, assign) GTUIButtonImageLocation imageLocation UI_APPEARANCE_SELECTOR;
 ...
 */
@property(nullable, nonatomic, strong) id<GTUIShapeGenerating> shapeGenerator;
 ...
 */
- (GTUIShadowElevation)elevationForState:(UIControlState)state;
 ...
 */
- (void)setElevation:(GTUIShadowElevation)elevation forState:(UIControlState)state;
