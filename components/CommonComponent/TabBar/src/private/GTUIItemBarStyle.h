...
@interface GTUIItemBarStyle : NSObject <NSCopying>
...
@property(nonatomic, nonnull) id<GTUITabBarIndicatorTemplate> selectionIndicatorTemplate;
...
@property(nonatomic) GTUIInkStyle inkStyle;
