...
@class GTUITabBarItem;
@protocol GTUITabBarDelegate;
@protocol GTUITabBarIndicatorTemplate;

typedef NS_ENUM(NSInteger, GTUITabBarItemState) {
    /** State for unselected tab bar item. */
    GTUITabBarItemStateNormal,
    /** State for selected tab bar item. */
    GTUITabBarItemStateSelected,
};
 ...
 */
IB_DESIGNABLE
@interface GTUITabBar : UIView <UIBarPositioning>
...
@property(nonatomic, weak, nullable) IBOutlet id<GTUITabBarDelegate> delegate;
...
/**
 ...
 for GTUITabBarItemStateSelected. Returns imageTintColorForState: for GTUITabBarItemStateSelected.
 */
...
/**
 ...
 for GTUITabBarItemStateNormal. Returns imageTintColorForState: for GTUITabBarItemStateNormal.
 */
...
/**
 ...
 By default this uses +[GTUITypography buttonFont]. Ignored for bottom-position tab bars.
...
/**
 ...
 By default this uses the GTUITypography button font. Ignored for bottom-position tab bars.
 ...
 */
@property(nonatomic) GTUITabBarAlignment alignment;
...
/**
 ...
 The default value is based on the position and is recommended for most applications.
 */
@property(nonatomic) GTUITabBarItemAppearance itemAppearance;
...
/**
 ...
 The default value is GTUITabBarTextTransformAutomatic.
 */
@property(nonatomic) GTUITabBarTextTransform titleTextTransform UI_APPEARANCE_SELECTOR;
 ...
 */
@property(nonatomic, null_resettable) id<GTUITabBarIndicatorTemplate> selectionIndicatorTemplate
...
/**
 ...
 If the @c GTUITabBarItemState value is not set, then defaults to a default value. Therefore,
 at a minimum, you should set the value for GTUITabBarItemStateNormal.
 */
...
/** Accessibility-related methods on GTUITabBar. */
@interface GTUITabBar (GTUIAccessibility)
...
/**
 Delegate protocol for GTUITabBar. Clients may implement this protocol to receive notifications of
 selection changes in the tab bar or to determine the bar's position.
 */
@protocol GTUITabBarDelegate <UIBarPositioningDelegate>
 ...
 */
- (BOOL)tabBar:(nonnull GTUITabBar *)tabBar shouldSelectItem:(nonnull UITabBarItem *)item;

/**
 Called before the selected item changes by user action. This method is not called for programmatic
 changes to the tab bar's selected item.  NOTE: Will be deprecated. Use tabBar:shouldSelectItem:.
 */
- (void)tabBar:(nonnull GTUITabBar *)tabBar willSelectItem:(nonnull UITabBarItem *)item;
 ...
 */
- (void)tabBar:(nonnull GTUITabBar *)tabBar didSelectItem:(nonnull UITabBarItem *)item;
