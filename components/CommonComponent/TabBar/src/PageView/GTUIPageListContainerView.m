...
@interface GTUIPageListContainerView() <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) GTUIPageListContainerCollectionView *collectionView;
@end

@implementation GTUIPageListContainerView

- (instancetype)initWithDelegate:(id<GTUIPageListContainerViewDelegate>)delegate {
...
- (void)initializeViews {
    ...
    _collectionView = [[GTUIPageListContainerCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
...
@interface GTUIPageListContainerCollectionView ()

@end

@implementation GTUIPageListContainerCollectionView
