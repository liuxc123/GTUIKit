 ...
 */
typedef NS_ENUM(NSInteger, GTUIColorSchemeDefaults) {
    /**
     The Material defaults, circa April 2018.
     */
    GTUIColorSchemeDefaults201804
};

/**
 A simple implementation of @c GTUIColorScheming that provides Material default color values from
 which basic customizations can be made.
 */
@interface GTUIColorScheme : NSObject <GTUIColorScheming>
 ...
 */
- (nonnull instancetype)initWithDefaults:(GTUIColorSchemeDefaults)defaults;
