...
@implementation GTUIColorScheme

- (instancetype)init {
    return [self initWithDefaults:GTUIColorSchemeDefaults201804];
}

- (instancetype)initWithDefaults:(GTUIColorSchemeDefaults)defaults {
    self = [super init];
    if (self) {
        switch (defaults) {
            case GTUIColorSchemeDefaults201804:
