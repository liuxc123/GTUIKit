//
//  GTFColorCalculations.m
//  GTFTextAccessibility
//
//  Created by liuxc on 2018/8/20.
//

#import "GTFColorCalculations.h"
...
static inline CGFloat GTFPow(CGFloat value, CGFloat exponent) {
...
static inline CGFloat LinearRGBComponent(CGFloat component) {
    if (component <= 0.03928f) {
        ...
        return GTFPow(((component + 0.055f) / 1.055f), 2.4f);
    }
}
...
static inline CGFloat ContrastRatioOfRGBComponents(const CGFloat *firstComponents,
    ...
    CGFloat firstLuminance = GTFRelativeLuminanceOfRGBComponents(firstComponents);
    CGFloat secondLuminance = GTFRelativeLuminanceOfRGBComponents(secondComponents);
...
CGFloat GTFMinAlphaOfColorOnBackgroundColor(UIColor *color,
    ...
    GTFContrastRatioOfRGBAComponents(colorComponents, backgroundColorComponents);
