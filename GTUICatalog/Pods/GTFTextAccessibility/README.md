...
GTFTextAccessibility assists in selecting text colors that will meet the
...
if any. GTFTextAccessibility provides convenient access to colors that will
...
GTFTextAccessibility provides methods that attempt to select a good color for
...
and black, see GTFTextAccessibility's
