...
@implementation NSString (GTBidi)
...
- (NSString *)gtf_stringWithBidiEmbedding {
    NSLocaleLanguageDirection languageDirection = [self gtf_calculatedLanguageDirection];

    return [self gtf_stringWithBidiEmbedding:languageDirection];
}

- (NSString *)gtf_stringWithBidiEmbedding:(NSLocaleLanguageDirection)languageDirection {
...
- (nonnull NSString *)gtf_stringWithStereoReset:(NSLocaleLanguageDirection)direction
    ...
    if (direction != NSLocaleLanguageDirectionLeftToRight &&
        direction != NSLocaleLanguageDirectionRightToLeft) {
        direction = [self gtf_calculatedLanguageDirection];
    }

    NSString *bidiEmbeddedString = [self gtf_stringWithBidiEmbedding:direction];
...
- (NSString *)gtf_stringWithBidiMarkersStripped {
