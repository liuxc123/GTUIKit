...
static UIImageOrientation GTFRTLMirroredOrientation(UIImageOrientation sourceOrientation) {
 ...
 */
static UIImage *GTFRTLFlippedImage(UIImage *image) {
...
@implementation UIImage (GTRTL)

- (UIImage *)gtf_imageWithHorizontallyFlippedOrientation {
...
#pragma clang diagnostic pop
        ...
        UIImageOrientation mirroredOrientation = GTFRTLMirroredOrientation(self.imageOrientation);
        if (self.CGImage) {
        ...
        if (!mirroredImage) {
            mirroredImage = GTFRTLFlippedImage(self);
        }
